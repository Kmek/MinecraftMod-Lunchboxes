...
public class ModFluidTypes {
    ...
    public static final ResourceLocation SOAP_OVERLAY_RL = new ResourceLocation(KLunchboxMod.MODID, "misc/in_soap_water"); // Unsure what this is used for

    public static final DeferredRegister<FluidType> FLUID_TYPES =
            DeferredRegister.create(ForgeRegistries.Keys.FLUID_TYPES, KLunchboxMod.MODID);
