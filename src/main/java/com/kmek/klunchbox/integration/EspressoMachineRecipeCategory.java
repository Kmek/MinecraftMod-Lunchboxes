...
import com.kmek.klunchbox.recipe.EspressoMachineRecipe;
...
public class EspressoMachineRecipeCategory implements IRecipeCategory<EspressoMachineRecipe> {
    public final static ResourceLocation UID = new ResourceLocation(KLunchboxMod.MODID, "espresso_machine");
    public final static ResourceLocation TEXTURE = new ResourceLocation(KLunchboxMod.MODID, "textures/gui/espresso_machine_gui.png");
    ...
    public RecipeType<EspressoMachineRecipe> getRecipeType() {
        return JEIKLunchboxPlugin.ESPRESSO_TYPE;
    }
