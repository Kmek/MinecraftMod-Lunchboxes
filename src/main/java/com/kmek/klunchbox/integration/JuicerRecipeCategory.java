...
import com.kmek.klunchbox.recipe.JuicerRecipe;
...
public class JuicerRecipeCategory implements IRecipeCategory<JuicerRecipe> {
    public final static ResourceLocation UID = new ResourceLocation(KLunchboxMod.MODID, "juicer");
    public final static ResourceLocation TEXTURE = new ResourceLocation(KLunchboxMod.MODID, "textures/gui/juicer_gui.png");
    ...
    public RecipeType<JuicerRecipe> getRecipeType() {
        return JEIKLunchboxPlugin.JUICER_TYPE;
    }
