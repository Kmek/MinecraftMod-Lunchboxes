...
public class ModCreativeTabInit {
    ...
    private void registerCustomCreativeTab(CreativeModeTabEvent.Register event) {
        ...
        event.registerCreativeModeTab(new ResourceLocation(KLunchboxMod.MODID, "klunchbox_tab2"), builder -> builder
                .title(Component.translatable("itemGroup.klunchbox_ingredients"))
        ...
        event.registerCreativeModeTab(new ResourceLocation(KLunchboxMod.MODID, "klunchbox_tab3"), builder -> builder
                .title(Component.translatable("itemGroup.klunchbox_food"))
        ...
        event.registerCreativeModeTab(new ResourceLocation(KLunchboxMod.MODID, "klunchbox_tab4"), builder -> builder
                .title(Component.translatable("itemGroup.klunchbox_drinks"))
