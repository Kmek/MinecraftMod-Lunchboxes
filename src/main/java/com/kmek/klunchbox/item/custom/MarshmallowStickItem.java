package com.kmek.klunchbox.item.custom;

import com.kmek.klunchbox.item.ModItemsInit;
import com.kmek.klunchbox.item.registery.MarshmallowStickEnum;
...
public class MarshmallowStickItem extends Item {
    private final String tagKeyToastiness = "klunchbox.toastiness";
